package ybanez.nostalgia.events
...
import ybanez.nostalgia.models.{HumanVsComputer, HumanVsHuman}
import ybanez.nostalgia.views.boards.{BoardView, PawnPromotionDialog}

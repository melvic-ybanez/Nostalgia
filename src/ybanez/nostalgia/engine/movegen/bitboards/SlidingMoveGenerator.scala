...
import ybanez.nostalgia.engine.board.bitboards.Transformers.Transformation
import ybanez.nostalgia.engine.board.bitboards.{Bitboard, Transformers}
import ybanez.nostalgia.engine.board.{Board, Piece}

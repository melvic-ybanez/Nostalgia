...
import ybanez.nostalgia.controllers.GameController
import ybanez.nostalgia.engine.board.{Board, Piece, Side}
import ybanez.nostalgia.engine.movegen.Location._
import ybanez.nostalgia.engine.movegen.{Location, Move}
import ybanez.nostalgia.events.{MoveEventHandler, PieceHoverEventHandler}
import ybanez.nostalgia.main.Resources
import ybanez.nostalgia.models._
...
case class DefaultBoardView(boardController: GameController) extends GridPane with BoardView {
  ...
  override def registerListeners(): Unit = {
    // register ybanez.nostalgia.events
